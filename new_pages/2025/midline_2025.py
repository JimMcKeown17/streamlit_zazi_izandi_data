...
def display_midline():
    ...
    try:
            ...
            with st.container():
                ...
                st.info(f"This is a measure of how many Grade 1 learners are hitting the benchmark threshold. It's 40 for end of Grade 1, however you may choose various thresholds since this is midline data.")
                
                benchmark_threshold = st.slider(
                    "Select benchmark threshold (letters correct)",
                    min_value=0,
                    max_value=60,
                    step=5,
                    value=40
                ...
                students_above_40 = len(g1_letter_scores[g1_letter_scores['letters_score_a1'] >= benchmark_threshold])
                ...
                fig = px.bar(
                    ...
                    title=f'Percentage of Grade 1 Learners with Letter Score >= {benchmark_threshold}',
                ...
                with col2:
                    st.metric(f"Students with Score >= {benchmark_threshold}", students_above_40)
                with col3:
            ...
            with st.container():
                ...
                school_letter_score_summary = g1_letter_scores.groupby('school_rep').agg(
                    ...
                    Above_40_Count=('letters_score_a1', lambda x: (x >= benchmark_threshold).sum())
                ).reset_index()
                ...
                fig = px.bar(
                    ...
                    x='school_rep',
                    y='Percentage_Above_40',
                    title=f'Percentage of Grade 1 Learners with Letter Score >= {benchmark_threshold} by School',
            ...
            with st.container():
                ...
                baseline_benchmark = baseline_grade_data.groupby('school_rep').agg(
                    Total_Assessed=('name_first_learner', 'count'),
                    Above_40_Count=('letters_correct_a1', lambda x: (x >= benchmark_threshold).sum())
                ).reset_index()
                ...
                fig = px.bar(
                    ...
                    color='Assessment Period',
                    barmode='group',
                    title=f'Baseline vs Midline Percentage at Benchmark by School - {grade_selection} (≥{benchmark_threshold})',
