...
from data_loader import load_zazi_izandi_east_london_2025_tp
import traceback
...
def display_2025_teampact():
    ...
    st.title("2025 TeamPact East London Assessments")
    ...
    try:
        if use_api:
            ...
            from data_loader import load_zazi_izandi_east_london_2025_tp_api
            result = load_zazi_izandi_east_london_2025_tp_api()
            ...
            xhosa_df, english_df, afrikaans_df = load_zazi_izandi_east_london_2025_tp()
